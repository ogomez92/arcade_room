...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'help.audio': 'The paddle is a low panned body tone, the ball is a moving rolling/air sound, and falling powerups have their own panned flutter.',
    ...
    es: {
      ...
      'help.audio': 'La pala es un tono grave paneado, la bola es un sonido móvil de rodadura y aire, y los poderes que caen tienen su propio aleteo paneado.',
