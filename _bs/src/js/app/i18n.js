...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'ann.level': 'Level {level}. {style} in {key}, {meter}. {mod} {notes} notes at {bpm} BPM. {subdiv}',
    ...
    es: {
      ...
      'ann.level': 'Nivel {level}. {style} en {key}, {meter}. {mod} {notes} notas a {bpm} pulsos por minuto. {subdiv}',
