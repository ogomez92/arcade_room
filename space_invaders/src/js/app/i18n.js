...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      // Audio tutorial (in-help guided demo of aim/lock/fire/pan)
      'help.tutorial': 'Audio tutorial',
      'help.tutorialStart': 'Start audio tutorial',
      'help.tutorialContinue': 'Press Enter to continue. Press Escape to exit.',
      'help.tutorialExit': 'Exit tutorial',
      'help.tutorialProgress': 'Step {n} of {total}',
      'help.tutorial1': 'Welcome to the audio tutorial. Listen — that low sine you hear is your aim cursor, sitting dead centre. It pans with your aim, so it always tells you where you are pointing. Press Enter to continue.',
      'help.tutorial2': 'Now let us hear the aim cursor sweep from far left to far right — exactly the way the arrow keys move it across the stereo field.',
      'help.tutorial3': 'Now let us hear a Scout approaching from the left. Bright square tone at 880 hertz, with short urgency pulses that get faster as it closes in.',
      'help.tutorial4': 'Now let us hear the target lock. The aim cursor has moved onto the Scout — listen for the fast trill in the ship\'s own voice. That trill means firing right now would connect.',
      'help.tutorial5': 'Now let us hear the Pulse weapon firing and connecting with the Scout. Pulse beats Scouts, so this is a clean kill — fire, bell-tone hit, then explosion.',
      'help.tutorial6': 'Now let us hear the wrong weapon — a Missile against a Scout. The shot fires, then a low thud: it bounced. No damage. That thud is your cue to switch weapons.',
      'help.tutorial7': 'Tutorial complete. Trust your ears, watch your energy, and pick the right weapon. Press Enter to return to the help page.',
      ...
      'learn.waveClear': 'Wave clear (clean) fanfare',
      'learn.waveSurvived': 'Wave survived (no bonus)',
      'learn.gameOver': 'Game over (somber sting)',
      'learn.aim': 'Aim crosshair tone (your position)',
      'learn.targetLock': 'Target lock (aim is on a ship)',
      ...
      'ann.energy': 'Energy {energy}, wave {wave}',
      ...
      'ann.shieldHeld': 'Shield held — energy {energy}',
      'ann.energyTick': 'Energy {percent}',
    ...
    es: {
      ...
      // Tutorial de audio dentro del Cómo se juega
      'help.tutorial': 'Tutorial de audio',
      'help.tutorialStart': 'Empezar tutorial de audio',
      'help.tutorialContinue': 'Pulsa Intro para continuar. Pulsa Escape para salir.',
      'help.tutorialExit': 'Salir del tutorial',
      'help.tutorialProgress': 'Paso {n} de {total}',
      'help.tutorial1': 'Bienvenido al tutorial de audio. Escucha: ese seno grave que oyes es tu mira, plantada justo en el centro. La mira se mueve con el paneo, así que siempre te indica dónde estás apuntando. Pulsa Intro para continuar.',
      'help.tutorial2': 'Ahora vamos a oír la mira barriendo desde el extremo izquierdo hasta el extremo derecho — igual que cuando la mueves con las flechas por el campo estéreo.',
      'help.tutorial3': 'Ahora vamos a oír un Caza acercándose por la izquierda. Una onda cuadrada brillante a 880 hercios, con pulsos cortos que se vuelven más rápidos a medida que se aproxima.',
      'help.tutorial4': 'Ahora vamos a oír el bloqueo. La mira se ha posado sobre el Caza — escucha ese trino rápido con la propia voz de la nave. Ese trino significa que si disparas ahora, das.',
      'help.tutorial5': 'Ahora vamos a oír el arma de Pulso disparando y dando al Caza. El Pulso vence al Caza, así que es un derribo limpio — disparo, campanada de impacto y explosión.',
      'help.tutorial6': 'Ahora vamos a oír el arma equivocada — un Misil contra un Caza. Sale el disparo y luego un golpe seco: ha rebotado. Sin daño. Ese golpe seco te dice que cambies de arma.',
      'help.tutorial7': 'Tutorial terminado. Confía en tu oído, vigila la energía y elige el arma adecuada. Pulsa Intro para volver a la página de ayuda.',
      ...
      'learn.waveClear': 'Oleada limpia (fanfarria)',
      'learn.waveSurvived': 'Oleada superada (sin bonus)',
      'learn.gameOver': 'Fin de partida (sting solemne)',
      'learn.aim': 'Tono de mira (tu posición)',
      'learn.targetLock': 'Mira fija (apuntas a una nave)',
      ...
      'ann.energy': 'Energía {energy}, oleada {wave}',
      ...
      'ann.shieldHeld': 'Escudo aguanta — energía {energy}',
      'ann.energyTick': 'Energía {percent}',
