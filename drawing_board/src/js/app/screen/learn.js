...
app.screen.learn = app.screenManager.invent({
  ...
  play: function (which) {
    ...
    A.setStaticListener()
    switch (which) {
      case 'filled': A.sampleFilled(); break
      case 'crossed': A.sampleCrossed(); break
      case 'unknown': A.sampleUnknown(); break
      case 'clue': A.sampleClue(); break
      case 'fill': A.fillCue(2, 2); break
      case 'mistake': A.mistake(); break
      case 'line': A.lineComplete(); break
