// High score persistence. Electron writes to a JSON file via the
// preload bridge; HTML5 falls back to localStorage. Up to 10 entries.
app.highscores = (() => {
  const KEY = 'missilecmd-highscores-v1'
  const MAX = 10
