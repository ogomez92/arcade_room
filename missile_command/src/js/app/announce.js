// Two aria-live regions: polite (routine events — score, wave, ammo) and
// assertive (state changes — city lost, wave clear, game over, pause).
//
// Identical strings get a clear-and-rewrite cycle so screen readers
// re-read instead of swallowing the duplicate.
app.announce = (() => {
