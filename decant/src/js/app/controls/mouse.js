app.controls.mouse = (() => {
  ...
  function requestPointerLock() {
    // Decant is a keyboard/gamepad puzzle with no mouse-look, so we never grab
    // pointer lock — it would only hijack Escape and disorient the player. Left
    // as a no-op intentionally.
  }
