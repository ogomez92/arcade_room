// Learn-the-sounds screen for Decant. Reachable from the #learn route.
app.screen.learn = app.screenManager.invent({
  ...
  play: function (which) {
    ...
    switch (which) {
      case 'colors': A.demoColors(A.colorCount()); break
      case 'pour': A.demoPour(); break
      case 'complete': A.demoComplete(); break
