 ...
 *
 * Registered as game id `rescue_mission` at https://scores.oriolgomez.com/admin
 * (display_order: desc, max_score: 9999999,
 * meta_schema: [{"key":"wave","type":"int","min":0,"max":999}]). On any
...
app.onlineScores = (() => {
  ...
  const GAME_ID = 'rescue_mission'
  const SECRET = 'oH4H4f-AcSru7WSZXD7oPzeXzp5f6sg-KNWG0Mp0h3E'
