// Thin UI wrapper around app.onlineScores.submit that drives a status line and
// a "view leaderboard" link, and falls back gracefully (local-only) when the
// service is unreachable or the game id is not yet registered.
app.onlineSubmit = (() => {
