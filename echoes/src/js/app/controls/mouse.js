app.controls.mouse = (() => {
  ...
  function requestPointerLock() {
    // Echoes is a keyboard/gamepad grid memory game with no mouse-look, so we
    // never grab pointer lock — it would only hijack Escape and disorient the
    // player. Left as a no-op intentionally.
  }
