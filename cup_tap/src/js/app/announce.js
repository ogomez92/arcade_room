 ...
 * TAPPER! — announcer.
 *
 * Two aria-live regions, polite and assertive. Re-read identical strings
 * by clearing the region, yielding via requestAnimationFrame, then re-set.
 *
 * Optional TTS fallback via SpeechSynthesis. Off by default.
 */
app.announce = (() => {
  let politeEl = null
