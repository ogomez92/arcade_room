...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'learn.up': 'Up — low, centre',
      'learn.down': 'Down — mid, centre',
      'learn.left': 'Left — high, panned left',
      ...
      // Multiplayer screen
      'mp.aria': 'Multiplayer lobby',
      'mp.title': 'Multiplayer',
      'mp.subtitle': 'Take turns: each miss passes to the next player. Lose 4 lives and you are out. Last player standing wins.',
      'mp.unavailable': 'Multiplayer is unavailable. PeerJS failed to load.',
      ...
      'mp.connecting': 'Connecting to room {code}…',
      'mp.hostingRoom': 'Room created. Code: {code}.',
      'mp.connected': 'Connected.',
      'mp.connectionClosed': 'Connection closed.',
      'mp.couldNotHost': 'Could not host the room.',
      'mp.couldNotConnect': 'Could not connect to the room.',
      'mp.left': 'You left the room.',
      'mp.peerJoined': '{name} joined.',
      'mp.peerLeft': '{name} left.',
      'mp.needTwo': 'Need at least two players to start.',
      'mp.tooMany': 'Too many players in this room.',
      'mp.statusHostNeed': 'Waiting for players. {count} so far.',
      'mp.statusHostReady': '{count} players ready. Press Start round to begin.',
      'mp.statusClient1': 'Connected. Waiting for the host to start.',
      ...
      'gameover.mpSubtitle': 'Final standings:',
      'gameover.mpReturn': 'Back to lobby',
      'gameover.mpRow': '{rank}. {name} — score {score}, level {level}',
    },
    ...
    es: {
      ...
      'learn.up': 'Arriba — grave, centrado',
      'learn.down': 'Abajo — medio, centrado',
      'learn.left': 'Izquierda — agudo, panorámica izquierda',
      ...
      // Multijugador
      'mp.aria': 'Sala multijugador',
      'mp.title': 'Multijugador',
      'mp.subtitle': 'Por turnos: cada fallo pasa al siguiente jugador. Pierdes 4 vidas y quedas eliminado. Gana el último que quede en pie.',
      'mp.unavailable': 'Multijugador no disponible. PeerJS no se ha cargado.',
      'mp.nameLabel': 'Tu nombre:',
      'mp.host': 'Crear sala',
      'mp.joinForm': 'Unirse con código de sala',
      'mp.backMenu': 'Volver al menú',
      'mp.codeLabel': 'Código de sala:',
      'mp.connect': 'Conectar',
      'mp.cancel': 'Atrás',
      'mp.lobbyRoomPrefix': 'Código de sala: ',
      'mp.lobbyShare': 'Compártelo con tus amigos para que se unan.',
      'mp.start': 'Empezar ronda',
      'mp.leave': 'Salir de la sala',
      'mp.tagHost': 'anfitrión',
      'mp.tagYou': 'tú',
      'mp.enterName': 'Escribe un nombre primero.',
      'mp.enterCode': 'Escribe un código de sala.',
      'mp.creating': 'Creando sala…',
      'mp.connecting': 'Conectando a sala {code}…',
      'mp.hostingRoom': 'Sala creada. Código: {code}.',
      'mp.connected': 'Conectado.',
      'mp.connectionClosed': 'Conexión cerrada.',
      'mp.couldNotHost': 'No se pudo crear la sala.',
      'mp.couldNotConnect': 'No se pudo conectar a la sala.',
      'mp.left': 'Has salido de la sala.',
      'mp.peerJoined': 'Se ha unido {name}.',
      'mp.peerLeft': '{name} se ha ido.',
      'mp.needTwo': 'Hacen falta al menos dos jugadores.',
      'mp.tooMany': 'Demasiados jugadores en la sala.',
      'mp.statusHostNeed': 'Esperando jugadores. {count} hasta ahora.',
      'mp.statusHostReady': '{count} jugadores listos. Pulsa Empezar ronda.',
      'mp.statusClient1': 'Conectado. Esperando a que el anfitrión empiece.',
      ...
      // Fin de partida (multijugador)
      'gameover.mpSubtitle': 'Clasificación final:',
      'gameover.mpReturn': 'Volver a la sala',
      'gameover.mpRow': '{rank}. {name} — puntos {score}, nivel {level}',
    },
  }
