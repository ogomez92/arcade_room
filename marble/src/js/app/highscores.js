// High score persistence. Electron writes a JSON file via the preload bridge;
// HTML5 falls back to localStorage. Up to 10 entries, sorted descending. Kept
// out of engine.state so it survives a state.reset(). (See CLAUDE.md.)
app.highscores = (() => {
  const KEY = 'marble-highscores-v1'
  const MAX = 10
