...
// events (level start, status readouts); assertive carries state changes
// (death, game over). Re-reads identical strings by clearing then re-setting on
// the next frame, since assistive tech swallows back-to-back identical text.
app.announce = (() => {
