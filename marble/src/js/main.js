;(async () => {
  ...
  app.updates.apply()
  // Marble keeps only high scores (see app.highscores); no full-state autosave.
  ...
  // We author our own per-cue tails (ADSR + lowpass), so kill the global
  // reverb send — otherwise one-shots smear. (See CLAUDE.md.)
