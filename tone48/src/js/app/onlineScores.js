 ...
 *
 * Registered as game id `tone48` at https://scores.oriolgomez.com (display_order:
 * desc, max_score: 1000000, meta_schema: [{"key":"level","type":"int","min":0,
 * "max":999}] — here `level` is the best tone's exponent). Any network failure
 * still falls back to the local high-score table — see
 * /home/scores/INTEGRATION.md.
 */
app.onlineScores = (() => {
  const BASE = 'https://scores.oriolgomez.com'
  const GAME_ID = 'tone48'
  const SECRET = 'iJ65KBguCWCtfzr7RpcpMsjT0L6r7jzJ84oikB4MtyA'
