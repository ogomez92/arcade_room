// Two aria-live regions: polite (routine: coins, pickups, score) and
// assertive (state changes: damage, level clear, death, pause). Toggling
// textContent (clear then re-set) makes screen readers re-read identical
// strings.
app.announce = (() => {
  let politeEl = null
