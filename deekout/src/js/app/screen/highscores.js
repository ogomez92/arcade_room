// Local per-difficulty leaderboard viewer. The "cycle" button rotates
// through easy/normal/crazy.
app.screen.highscores = app.screenManager.invent({
  ...
  render: function () {
    ...
    list.forEach((e, i) => {
      const li = document.createElement('li')
      li.textContent = app.i18n.t('highscores.entry', {rank: i + 1, name: e.name, score: e.score, level: e.level})
      s.listEl.appendChild(li)
    })
  },
  onFrame: function () {
