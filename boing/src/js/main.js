;(async () => {
  ...
  // ALOFT authors its own per-cue tails (ADSR + lowpass) and its own music bed,
  // so kill syngen's always-on global reverb send — otherwise every one-shot
  // smears (a re-fired cue would sound like a reverb wash).
