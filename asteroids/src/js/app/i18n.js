...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'help.arcadeRapidFire': 'Rapid Fire — for 15 seconds, hold Space to fire continuously (no 4-bullet cap).',
    ...
    es: {
      ...
      'help.arcadeRapidFire': 'Fuego Rápido — durante 15 segundos, mantén Espacio para disparar sin parar (sin el límite de 4 balas).',
