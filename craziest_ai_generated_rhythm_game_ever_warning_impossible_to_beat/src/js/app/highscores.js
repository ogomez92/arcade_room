// Local high score persistence. Electron writes a JSON file via the preload
// bridge; HTML5 falls back to localStorage. Up to 10 entries, descending.
app.highscores = (() => {
  const KEY = 'cadence-highscores-v1'
  const MAX = 10
