 ...
 *
 * REGISTRATION PENDING: this game id must be registered at
 * https://scores.oriolgomez.com/admin (display_order: desc, max_score: 9999999,
 * meta_schema: [{"key":"level","type":"int","min":0,"max":999}]). Paste the
 * returned secret over SECRET below. Until then, submissions fall back to the
 * local high-score table — see /home/scores/INTEGRATION.md.
 */
app.onlineScores = (() => {
  const BASE = 'https://scores.oriolgomez.com'
  const GAME_ID = 'cadence'
  const SECRET = 'REPLACE_WITH_CADENCE_SECRET'
