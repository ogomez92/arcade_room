...
// build the vocabulary before playing. Reachable from the menu and #learn route.
app.screen.learn = app.screenManager.invent({
  ...
  onReady: function () {
    ...
    root.addEventListener('click', (e) => {
      ...
      if (sound) { content.audio.sample(sound.dataset.sound); return }
  ...
  onFrame: function () {
    try {
      ...
      if (ui.enter || ui.space || ui.confirm) {
        ...
        if (f && f.dataset.sound) { content.audio.sample(f.dataset.sound); return }
